  ...
  return (
    <div className={styles.loginComponent}>
      <Paper className={styles.card} elevation={6} >
        ...
        <Button onClick={() => {setLoadingButton(true); login(username, password, setError).finally(() => setLoadingButton(false))}} className={styles.loginButton} variant="contained" disabled={loadingButton}>
          {loadingButton ? 
